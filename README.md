...
| Keybind | Action |
| :--- | :--- |
| `Shift + Alt + T` | Toggle Mod Menu UI |
| `G` | Default Fast Feed Combo |
| `H` | Toggle/Hold Fast Feed Spam |
| `R` | Toggle/Hold Quad Feed |
| `F` | Trigger Main Sequence |
| `P` | Trigger Pre-split Sequence |
